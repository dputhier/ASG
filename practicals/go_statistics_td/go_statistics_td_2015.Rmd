---
title: "Statistics for Bioinformatics - Practicals - Gene enrichment statistics"
...
the Web tool [DAVID](http://david.ncifcrf.gov/home.jsp), to compare it to various catalogues of functional annotations (Gene Ontology, KEGG, ...). DAVID returned a table reporting the functional classes for which our gene set showed significant enrichment.
...
Did we obtain the same P-value as DAVID ? If not, read [David help page](http://david.ncifcrf.gov/helps/functional_annotation.html#fisher) and try to understand the reason for the difference.
